    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_name', models.CharField(max_length=20, verbose_name=b'Contact number')),
                ('email', models.CharField(max_length=20, verbose_name=b'Email address')),
                ...
                ('mc_id', models.CharField(default=b'', max_length=6, verbose_name=b'Motor carrier number')),
